...
from ._bgr import bgr2gray, bgr2hls, bgr2hsv, bgr2lab
...
def yuv2bgr(tens) -> Tensor:
    ...
    if not _is_yuv_image(tens):
        raise ValueError(f'Tensor of shape 3 expected. Found shape {len(tens.shape)}. This function converts an YUV Tensor to its BGR counterpart')
...
def yuv2rgb(tens) -> Tensor:
    ...
    """
    if not _is_yuv_image(tens):
        raise ValueError(f'Tensor of shape 3 expected. Found shape {len(tens.shape)}. This function converts a YUV Tensor to its RGB counterpart')
...
def yuv2gray(tens) -> Tensor:
    ...
    """
    if not _is_yuv_image(tens):
        raise ValueError(f'Tensor of shape 3 expected. Found shape {len(tens.shape)}. This function converts an YUV Tensor to its GRAY counterpart')
...
def yuv2hls(tens) -> Tensor:
    ...
    """
    if not _is_yuv_image(tens):
        raise ValueError(f'Tensor of shape 3 expected. Found shape {len(tens.shape)}. This function converts an YUV Tensor to its HLS counterpart')
...
def yuv2hsv(tens) -> Tensor:
    ...
    """
    if not _is_yuv_image(tens):
        raise ValueError(f'Tensor of shape 3 expected. Found shape {len(tens.shape)}. This function converts an YUV Tensor to its HSV counterpart')
...
def yuv2lab(tens) -> Tensor:
    ...
    """
    if not _is_yuv_image(tens):
        raise ValueError(f'Tensor of shape 3 expected. Found shape {len(tens.shape)}. This function converts an YUV Tensor to its LAB counterpart')
