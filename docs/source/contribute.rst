...
If you are interested or have already written a story covering ``Caer``, you can submit your story in a ``markdown`` format as a PR to https://github.com/jasmcaus/caer/tree/master/resources. 
