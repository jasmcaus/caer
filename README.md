...
| [**caer.video**](https://caer.org/docs/stable/autograd.html) | a tape-based automatic differentiation library that supports all differentiable Tensor operations in caer |
| [**caer.data**](https://caer.org/docs/stable/jit.html) | a compilation stack (caerScript) to create serializable and optimizable models from caer code  |
...
| [**caer.utils**](https://caer.org/docs/stable/data.html) | DataLoader and other utility functions for convenience |
